...
/* Make the signal names work for the ATmega169 */

#define	SIG_UART_DATA SIG_USART_DATA
#define SIG_UART_RECV SIG_USART_RECV
#define SIG_UART_TRANS SIG USART_TRANS
...
unsigned int baudrate = 12;
	...
	portENTER_CRITICAL();
	{
		...
		//UBRR = (portSHORT)ulBaudRateCounter;
		/* Set the baud rate. */	
...
//		UBRRH = ucByte;
    ...
    UCSRA = (1<<U2X);
		...
		/* Set the data bits to 8., Stop:1, Parity: None */
